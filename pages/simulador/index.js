...
export const Simulador = () => {
  ...
  return (
    <div>
        ...
        <div className="row justify-content-center mx-0 mb-5 mt-4">
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-4">
            <div className="d-flex align-items-start ">
              <div className={`col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right ${styles['title-value-simulator']}`}>
                Necesito
              </div>
              <div className={`col-xs-6 col-sm-6 col-md-6 col-lg-6 ${styles['value-side']}`}>
                <p>${valueSlider}</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 mt-4">
            ...
            <div className="d-flex align-items-start ">
              <div className={`col-xs-4 col-md-6 ${styles['input-text']}`}>Quiero pagarlo en</div>
          ...
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 mt-4">
            ...
            <div className="d-flex align-items-start ">
              <div className={`col-xs-4 col-md-6  ${styles['input-text']}`}>Quiero plazos</div>
              <div className="col-xs-8 col-md-6">
          ...
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 mt-4">
            ...
            <div className="d-flex align-items-start ">
              <div className={`col-xs-4 col-md-6  ${styles['input-text']}`}>Mi empresa tiene</div>
              <div className="col-xs-8 col-md-6">
          ...
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 mt-4">
            ...
            <div className="d-flex align-items-start ">
              <div className={`col-xs-4 col-sm-6 col-md-6 ${styles['input-text']}`}>Al año vendo</div>
      ...
      {resultState && (
        <div className={`container col-sm-8 col-md-8 col-lg-8 ${styles['title-info']}`}>
          ...
          <div className={'container col-xs-12 col-sm-12 col-md-12 col-lg-12'}>
            <div className={`row  mx-0 mb-5 mt-2 `}>
                ...
                <div>
                  ...
                  <div className="text-left">
                    <button
                      type="button"
                      onClick={() => setResulState(resultState => !resultState)}
                      className={`col-md-8 mt-3 ${menuOpen ? 'btn-medium-yellow' : 'btn-medium'}`}
                    >
              ...
              <div className={`col-xs-12 col-sm-12 col-md-12 mt-5 mb-4 `}>
                <h1 className={`col-xs-12 col-sm-12 col-md-12  ${styles['last-title']}`}>
