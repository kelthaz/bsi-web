          ...
          <div className="row mx-md-0 mb-5 mt-2">
            <div className="justify-content-center col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-2">
              <div className="d-flex justify-content-center ">
                <div className={` col-xs-6 col-sm-6 col-md-12 col-lg-12 ${styles['value-side']}`}>
                  <div className="row justify-content-center ">
                    <div className={`d-none d-sm-block   ${styles['title-value-simulator']} `}>Necesito &nbsp;</div>
            ...
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 mt-4 pr-lg-0">
              <h1 className={`text-xs-center text-md-left d-block d-sm-none ${styles['title-input']}`}>¿En cuántos meses quieres <br></br> pagarlo?</h1>
              <h1 className={`text-xs-center text-md-left d-none d-md-block ${styles['title-input']}`}>¿En cuántos meses quieres pagarlo?</h1>
            ...
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 mt-4 ">
              <h2 className={`text-xs-center text-md-left d-block d-sm-none ${styles['title-input']}`}>¿Cómo quieres los plazos <br></br> de tu pago?</h2>
              <h2 className={`text-xs-center text-md-left d-none d-md-block ${styles['title-input']}`}>¿Cómo quieres los plazos de tu pago?</h2>
              <div className="d-flex align-items-start ">
            ...
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 mt-4 pr-md-0 ">
              <h2 className={`text-xs-center text-md-left d-block d-sm-none ${styles['title-input']}`}>¿Cuál es la antigüedad <br></br> de tu empresa ?</h2>
              <h2 className={`text-xs-center text-md-left d-none d-md-block ${styles['title-input']}`}>¿Cuál es la antigüedad de tu empresa ?</h2>
              <div className="d-flex align-items-start ">
      ...
      {resultState && (
        <div>
          <div className={`container col-sm-8 col-md-6 col-lg-6 px-0  ${styles['title-info']}`}>
            ...
            <div className={`container ${styles['result-info']}`}>
              <div className="row mx-0 mb-4 mt-4">
                ...
                <div className="text-left order-md-2 col-xs-6 col-sm-6 col-md-5 col-lg-3 pl-xs-4 pl-md-3 pl-lg-3">
                ...
                <div className="text-left order-md-5 col-xs-6 col-sm-6 col-md-6 col-lg-3 mt-xs-4 mt-md-4 pl-xs-4 pl-md-3 pl-lg-3">
                  <h1 className={styles['title-input']}>2%</h1>
                  <div className={styles['input-text']}>Comisión por apertura</div>
                </div>
                <div className="text-left order-xs-4 order-md-5 col-xs-6 col-sm-6 col-md-6 col-lg-3 mt-xs-4 mt-md-4 pl-xs-4 pl-md-3 pl-lg-3">
          ...
          <div className={'container col-xs-12 col-sm-12 col-md-12 col-lg-12'}>
            <div className={`row justify-content-center mx-0 mb-5 mt-2 `}>
              <div
              ...
              >
                ...
                <div className="col-md-9 col-lg-6 col-xs-9 pr-md-0 px-xs-1">
                  <p className="d-block d-sm-none col-md-12 col-lg-10 col-xs-11  px-md-0 px-xs-0 mx-md-0 ml-lg-5">
                    ¿Ya habías comenzado tu solicitud? ¡Retómala aquí!
                  </p>
                  <p className="d-none d-md-block col-md-12 col-lg-10 col-xs-12  px-md-0 px-xs-0 mx-md-0 ml-lg-5">
                    ¿Ya habías comenzado tu solicitud? <br></br> ¡Retómala aquí!
                  </p>
                  <button
                    className="col-xs-9 col-md-7 col-lg-7 btn-link-blue-sky mx-md-0 mx-lg-4 pl-xs-0 px-md-1 px-lg-4 mr-md-3 mb-xs-5"
                    type="button"
                  >
                    Retoma tu proceso
                  </button>
                </div>
                <div className="col-md-4 mt-md-1 px-0">
                  <img alt="" src="/Sesion.png" />
                </div>
              </div>
              <div className={`col-xs-12 col-sm-12 col-md-6 col-lg-6 mt-md-4 px-0 ${styles['container-flex']}`}>
                <div className="col-md-10 col-lg-6 col-xs-9 px-xs-0">
                  ...
                  <button
                    type="button"
                    className={`d-none d-md-block ml-md-4 col-md-7 col-lg-6 mt-3 ${
                  ...
                  <button
                    type="button"
                    onClick={() => setResulState(resultState => !resultState)}
                    className={`d-block d-sm-none col-xs-8 col-md-4 col-lg-8 mt-3 ml-xs-5 mt-xs-4 ${
                      menuOpen ? 'btn-medium-yellow' : 'btn-medium'
                    }`}
                  >
                ...
                <div className="col-md-2 col-lg-6 col-sm-3 mt-md-0 mt-xs-4 px-0">
