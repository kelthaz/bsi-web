...
const Home = () => {
  ...
  let banner_text_block = (
    ...
    <div className={`row justify-content-center ${styles.text_title}`}>
      <TitleBanner linea1="Da el siguiente" linea2="gran salto"
  ...
  let banner_image_block = (
    <div>
      <div className={styles.banner_image_texture}><img src="/BC_PYMES_1 2.svg"/></div>
      <div className={styles.banner_image_man}><img src="/BC_PYMES_1 1.png"/></div>
    </div>
  );
