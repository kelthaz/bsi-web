...
const StepTwoPm = () => {
  ...
  const { documentacion, currentStep, datosPersonales } = useSelector((state) => state.obligado);
  ...
  const formulario = useFormik({
    initialValues: {
      ...
      ejercenControlFisico: documentacion.ejercenControlFisico,
    },
