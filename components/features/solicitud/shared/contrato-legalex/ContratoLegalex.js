    ...
    <>
      ...
      <div className="row justify-content-between">
        ...
        <div className="d-md-none">
          <button type="button" className="btn-link" onClick={() => setOpenModalMobile(!openModalMobile)}>
      ...
      <div className="card-simple-white-shadow">
        ...
        <div className="body2">
          <p className="mb-4">
            ...
            funcionarios facultados lleve a cabo investigaciones sobre mi comportamiento crediticio o el de la empresa
            que represento en las sociedades de información crediticia que estime conveniente.
          </p>
          <p className="mb-3">
            Asimismo declaro que conozco la naturaleza de las sociedades de información crediticia y de la información
            contenida en los reportes de crédito y reporte de crédito especial; declaro que conozco la naturaleza
            alcance de la información que se solicitará, del uso que{' '}
            <span className="sub">BanCoppel, S.A., Institución de banca Múltiple</span>, hará de tal información y de
            que esta podrá realizar consultas periódicas de mi historial crediticio o el de la empresa que represento,
            consintiendo que esta autorización se encuentre vigente por un periodo de 3 años contando a partir de la
            fecha de sus expedición y en todo caso durante el tiempo que mantengamos relación jurídica.
          </p>
          <p className="mb-3">
