...
const PasoDosObligadoSolidarioPM = ({ validate }) => {
  ...
  const formulario = useFormik({
    initialValues: {
      ...
      domicilioComercial: { ...obligadoSolidario.domicilioComercial },
      esDomilicioComercial: obligadoSolidario.esDomilicioComercial,
      domicilioEntrega: obligadoSolidario.domicilioEntrega,
    },
