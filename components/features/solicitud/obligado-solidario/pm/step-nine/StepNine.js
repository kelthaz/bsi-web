...
const StepNine = () => {
  ...
  const { pm } = useSelector((state) => state.solicitud);
              ...
              <div className="card-simple-white-shadow">
                ...
                <div className="body2">
                  <p className="mb-4">
                    ...
                    de la empresa que represento en las sociedades de información crediticia que estime conveniente.
                  </p>
                  <p className="mb-3">
                    ...
                    la naturaleza alcance de la información que se solicitará, del uso que{' '}
                    <span className="sub">BanCoppel, S.A., Institución de banca Múltiple</span>, hará de tal información
                    y de que esta podrá realizar consultas periódicas de mi historial crediticio o el de la empresa que
                    represento, consintiendo que esta autorización se encuentre vigente por un periodo de 3 años
                    contando a partir de la fecha de sus expedición y en todo caso durante el tiempo que mantengamos
                    relación jurídica.
                  </p>
                  <p className="mb-3">
