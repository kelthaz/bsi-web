...
const PasoCincoObligadoSolidarioPFAE = () => {
  ...
  const formulario = useFormik({
    initialValues: {
      inmueblesPropiosSinGravamen: pfae.inmueblesPropiosSinGravamen,
      tieneInmueblesPropiosSinGravamen: pfae.tieneInmueblesPropiosSinGravamen,
      cantidadInmueblesPropiosSinGravamen: pfae.cantidadInmueblesPropiosSinGravamen,
    },
